...
import Two from '../../Assets/vpre.jpg';
        ...
        <Grid item xs={12} sm={4} md={5}>
          <Slide direction="left" in={true} timeout={3000}>
            <Paper elevation={3} sx={{ p: { xs: 2, sm: 3, md: 4 }, textAlign: 'justify', mb: 2 }}>
              ...
              Sanjay Patel, a seasoned educator with a focus on student welfare and discipline, serves as the Vice Principal of Royal Public School. His leadership fosters a conducive learning environment for all students.              </Typography>
            </Paper>
          </Slide>
        </Grid>
      </Grid>
